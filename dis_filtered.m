function varargout = dis_filtered(varargin)
% dis_filtered MATLAB code for dis_filtered.fig
%      dis_filtered, by itself, creates a new dis_filtered or raises the existing
%      singleton*.
%
%      H = dis_filtered returns the handle to a new dis_filtered or the handle to
%      the existing singleton*.
%
%      dis_filtered('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in dis_filtered.M with the given input arguments.
%
%      dis_filtered('Property','Value',...) creates a new dis_filtered or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dis_filtered_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dis_filtered_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dis_filtered

% Last Modified by GUIDE v2.5 26-May-2014 20:47:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dis_filtered_OpeningFcn, ...
                   'gui_OutputFcn',  @dis_filtered_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dis_filtered is made visible.
function dis_filtered_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dis_filtered (see VARARGIN)
crcdef = crc_get_defaults('one');
set(0,'CurrentFigure',handles.figure1);
warning('off')

% Choose default command line output for dis_score
...
if isfield(varargin{1},'multcomp') %if comparing multiple files
    ...
    %函数windowbuttondownfcn，当鼠标在窗口上运动的时候就会相应此函数，
    ...
    set(handles.totaltime1,'String',['/ ' num2str(handles.maxx)]);
    set(handles.currenttime1,'String',num2str(round(handles.winsize/2)));
    set(handles.totalpage1,'String',['/ ' num2str(ceil(handles.maxx/handles.winsize))]);
    set(handles.currentpage1,'String',num2str(1));
    
    %disables channel slider
    set(handles.Chanslider1,'enable','off')
...
set(handles.frqabv1,'String',num2str(handles.filter.other(2)));
set(handles.upemg1,'String',num2str(handles.filter.EMG(2)));

% popupmenu setting
popupmenustring	=   [popupmenustring 'REF1'];
set(handles.EEGpopmenu1,...
    'String',popupmenustring,...
    'Value',length(popupmenustring))
set(handles.otherpopmenu1,...
    'String',popupmenustring,...
    'Value',length(popupmenustring))
popupmenustring = [popupmenustring 'BIPOLAR'];
set(handles.EOGpopmenu1,...
    'String',popupmenustring,...
    'Value',length(popupmenustring))
set(handles.EMGpopmenu1,...
    'String',popupmenustring,...
    'Value',length(popupmenustring))
...
if ~handles.multcomp
  ...
  %set(handles.popupmenu10,...
   %     'String',pmstring,...
    ...
    set(handles.figure1, 'windowbuttondownfcn', @update_powerspect)
...
% UIWAIT makes dis_filtered wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dis_filtered_OutputFcn(hObject, eventdata, handles) 
...
function currenttime1_Callback(hObject, eventdata, handles)
% hObject    handle to currenttime11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currenttime11 as text
%        str2double(get(hObject,'String')) returns contents of currenttime11 as a double
i=handles.minsamp;
...
% --- Executes during object creation, after setting all properties.
function currenttime1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currenttime11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function Chanslider1_Callback(hObject, eventdata, handles)
% hObject    handle to Chanslider1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'Value') returns position of slider
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
slidval = get(handles.Chanslider1,'Value');
set(handles.Chanslider1,'Value',slidval-rem(slidval,1))
mainplot(handles);
guidata(hObject, handles);


% --- Executes during object creation, after setting all properties.
function Chanslider1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Chanslider1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function currentpage1_Callback(hObject, eventdata, handles)
% hObject    handle to currentpage11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currentpage11 as text
%        str2double(get(hObject,'String')) returns contents of currentpage11 as a double
i=handles.minsamp;
...
% --- Executes during object creation, after setting all properties.
function currentpage1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currentpage11 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrblw1_Callback(hObject, eventdata, handles)
% hObject    handle to pwrblw1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrblw1 as text
%        str2double(get(hObject,'String')) returns contents of pwrblw1 as a double
if get(handles.counterspect,'Value')
    ...
    Chanslidval     =   get(handles.Chanslider1,'Value');
    ...
    if length(X) == 1
        ...
        grid on
        axis auto
        xd  = str2double(get(handles.pwrblw1,'String'));
        xf = str2double(get(handles.pwrabv1,'String'));
...
% --- Executes during object creation, after setting all properties.
function pwrblw1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrblw1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrabv1_Callback(hObject, eventdata, handles)
% hObject    handle to pwrabv1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrabv1 as text
%        str2double(get(hObject,'String')) returns contents of pwrabv1 as a double
if get(handles.counterspect,'Value')
    set(handles.figure1,'CurrentAxes',handles.axes5);
...
% --- Executes during object creation, after setting all properties.
function pwrabv1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrabv1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function currenttime2_Callback(hObject, eventdata, handles)
% hObject    handle to currenttime12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currenttime12 as text
%        str2double(get(hObject,'String')) returns contents of currenttime12 as a double


% --- Executes during object creation, after setting all properties.
function currenttime2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currenttime12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function Chanslider2_Callback(hObject, eventdata, handles)
% hObject    handle to Chanslider2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function Chanslider2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Chanslider2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function currentpage2_Callback(hObject, eventdata, handles)
% hObject    handle to currentpage12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currentpage2 as text
%        str2double(get(hObject,'String')) returns contents of currentpage12 as a double


% --- Executes during object creation, after setting all properties.
function currentpage2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currentpage12 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrblw2_Callback(hObject, eventdata, handles)
% hObject    handle to pwrblw2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrblw2 as text
%        str2double(get(hObject,'String')) returns contents of pwrblw2 as a double


% --- Executes during object creation, after setting all properties.
function pwrblw2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrblw2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrabv2_Callback(hObject, eventdata, handles)
% hObject    handle to pwrabv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrabv2 as text
%        str2double(get(hObject,'String')) returns contents of pwrabv2 as a double


% --- Executes during object creation, after setting all properties.
function pwrabv2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrabv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function currenttime3_Callback(hObject, eventdata, handles)
% hObject    handle to currenttime13 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currenttime13 as text
%        str2double(get(hObject,'String')) returns contents of currenttime13 as a double


% --- Executes during object creation, after setting all properties.
function currenttime3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currenttime13 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function currentpage3_Callback(hObject, eventdata, handles)
% hObject    handle to currentpage13 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of currentpage3 as text
%        str2double(get(hObject,'String')) returns contents of currentpage13 as a double


% --- Executes during object creation, after setting all properties.
function currentpage3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to currentpage3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrblw3_Callback(hObject, eventdata, handles)
% hObject    handle to pwrblw3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrblw3 as text
%        str2double(get(hObject,'String')) returns contents of pwrblw3 as a double


% --- Executes during object creation, after setting all properties.
function pwrblw3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrblw3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pwrabv3_Callback(hObject, eventdata, handles)
% hObject    handle to pwrabv3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pwrabv3 as text
%        str2double(get(hObject,'String')) returns contents of pwrabv3 as a double


% --- Executes during object creation, after setting all properties.
function pwrabv3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pwrabv3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on slider movement.
function Chanslider3_Callback(hObject, eventdata, handles)
% hObject    handle to Chanslider3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function Chanslider3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Chanslider3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function downemg1_Callback(hObject, eventdata, handles)
% hObject    handle to downemg1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downemg1 as text
%        str2double(get(hObject,'String')) returns contents of downemg1 as a double
...
% --- Executes during object creation, after setting all properties.
function downemg1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downemg1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upemg1_Callback(hObject, eventdata, handles)
% hObject    handle to upemg1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upemg1 as text
%        str2double(get(hObject,'String')) returns contents of upemg1 as a double
frbe	=   str2double(get(hObject,'String'));
i   =   handles.minsamp;
if not(isnan(frbe)) && length(frbe)==1
...
% --- Executes during object creation, after setting all properties.
function upemg1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upemg1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function downeog1_Callback(hObject, eventdata, handles)
% hObject    handle to downeog1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downeog1 as text
%        str2double(get(hObject,'String')) returns contents of downeog1 as a double
frbe=str2double(get(hObject,'String'));
i=handles.minsamp;
if not(isnan(frbe)) && length(frbe)==1
    if frbe<0.0001
...
% --- Executes during object creation, after setting all properties.
function downeog1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downeog1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upeog1_Callback(hObject, eventdata, handles)
% hObject    handle to upeog1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upeog1 as text
%        str2double(get(hObject,'String')) returns contents of upeog1 as a double
frbe	=   str2double(get(hObject,'String'));
i   =   handles.minsamp;
if not(isnan(frbe)) && length(frbe)==1
    if frbe>fsample(handles.Dmeg{i})/2*.99
...
% --- Executes during object creation, after setting all properties.
function upeog1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upeog1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqblw1_Callback(hObject, eventdata, handles)
% hObject    handle to frqblw1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqblw1 as text
%        str2double(get(hObject,'String')) returns contents of frqblw1 as a double
frbe    =   str2double(get(hObject,'String'));
i       =   handles.minsamp;
if not(isnan(frbe)) && length(frbe)==1
    if frbe<0.0001
...
% --- Executes during object creation, after setting all properties.
function frqblw1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqblw1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqabv1_Callback(hObject, eventdata, handles)
% hObject    handle to frqabv1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqabv1 as text
%        str2double(get(hObject,'String')) returns contents of frqabv1 as a double
frbe = str2double(get(hObject,'String'));
i = handles.minsamp;
if not(isnan(frbe)) && length(frbe)==1
...
% --- Executes during object creation, after setting all properties.
function frqabv1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqabv1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EEGpopmenu1.
function EEGpopmenu1_Callback(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EEGpopmenu1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EEGpopmenu1
mainplot(handles)


% --- Executes during object creation, after setting all properties.
function EEGpopmenu1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EOGpopmenu1.
function EOGpopmenu1_Callback(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EOGpopmenu1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EOGpopmenu1

mainplot(handles)

% --- Executes during object creation, after setting all properties.
function EOGpopmenu1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EMGpopmenu1.
function EMGpopmenu1_Callback(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EMGpopmenu1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EMGpopmenu1
mainplot(handles)


% --- Executes during object creation, after setting all properties.
function EMGpopmenu1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in otherpopmenu1.
function otherpopmenu1_Callback(hObject, eventdata, handles)
% hObject    handle to otherpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns otherpopmenu1 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from otherpopmenu1
mainplot(handles)


% --- Executes during object creation, after setting all properties.
function otherpopmenu1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to otherpopmenu1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function downemg3_Callback(hObject, eventdata, handles)
% hObject    handle to downemg3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downemg3 as text
%        str2double(get(hObject,'String')) returns contents of downemg3 as a double


% --- Executes during object creation, after setting all properties.
function downemg3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downemg3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upemg3_Callback(hObject, eventdata, handles)
% hObject    handle to upemg3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upemg3 as text
%        str2double(get(hObject,'String')) returns contents of upemg3 as a double


% --- Executes during object creation, after setting all properties.
function upemg3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upemg3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function downeog3_Callback(hObject, eventdata, handles)
% hObject    handle to downeog3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downeog3 as text
%        str2double(get(hObject,'String')) returns contents of downeog3 as a double


% --- Executes during object creation, after setting all properties.
function downeog3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downeog3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upeog3_Callback(hObject, eventdata, handles)
% hObject    handle to upeog3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upeog3 as text
%        str2double(get(hObject,'String')) returns contents of upeog3 as a double


% --- Executes during object creation, after setting all properties.
function upeog3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upeog3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqblw3_Callback(hObject, eventdata, handles)
% hObject    handle to frqblw3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqblw3 as text
%        str2double(get(hObject,'String')) returns contents of frqblw3 as a double


% --- Executes during object creation, after setting all properties.
function frqblw3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqblw3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqabv3_Callback(hObject, eventdata, handles)
% hObject    handle to frqabv3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqabv3 as text
%        str2double(get(hObject,'String')) returns contents of frqabv3 as a double


% --- Executes during object creation, after setting all properties.
function frqabv3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqabv3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EEGpopmenu3.
function EEGpopmenu3_Callback(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EEGpopmenu3 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EEGpopmenu3

% --- Executes on selection change in EOGpopmenu3.
function EOGpopmenu3_Callback(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EOGpopmenu3 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EOGpopmenu3


% --- Executes on selection change in otherpopmenu3.
function otherpopmenu3_Callback(hObject, eventdata, handles)
% hObject    handle to otherpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns otherpopmenu3 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from otherpopmenu3

function downemg2_Callback(hObject, eventdata, handles)
% hObject    handle to downemg2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downemg2 as text
%        str2double(get(hObject,'String')) returns contents of downemg2 as a double


% --- Executes during object creation, after setting all properties.
function downemg2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downemg2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upemg2_Callback(hObject, eventdata, handles)
% hObject    handle to upemg2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upemg2 as text
%        str2double(get(hObject,'String')) returns contents of upemg2 as a double


% --- Executes during object creation, after setting all properties.
function upemg2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upemg2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function downeog2_Callback(hObject, eventdata, handles)
% hObject    handle to downeog2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of downeog2 as text
%        str2double(get(hObject,'String')) returns contents of downeog2 as a double


% --- Executes during object creation, after setting all properties.
function downeog2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to downeog2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function upeog2_Callback(hObject, eventdata, handles)
% hObject    handle to upeog2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of upeog2 as text
%        str2double(get(hObject,'String')) returns contents of upeog2 as a double


% --- Executes during object creation, after setting all properties.
function upeog2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to upeog2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqblw2_Callback(hObject, eventdata, handles)
% hObject    handle to frqblw2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqblw2 as text
%        str2double(get(hObject,'String')) returns contents of frqblw2 as a double


% --- Executes during object creation, after setting all properties.
function frqblw2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqblw2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function frqabv2_Callback(hObject, eventdata, handles)
% hObject    handle to frqabv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of frqabv2 as text
%        str2double(get(hObject,'String')) returns contents of frqabv2 as a double


% --- Executes during object creation, after setting all properties.
function frqabv2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frqabv2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EEGpopmenu2.
function EEGpopmenu2_Callback(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EEGpopmenu2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EEGpopmenu2


% --- Executes during object creation, after setting all properties.
function EEGpopmenu2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EOGpopmenu2.
function EOGpopmenu2_Callback(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EOGpopmenu2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EOGpopmenu2


% --- Executes during object creation, after setting all properties.
function EOGpopmenu2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EMGpopmenu2.
function EMGpopmenu2_Callback(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EMGpopmenu2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EMGpopmenu2


% --- Executes during object creation, after setting all properties.
function EMGpopmenu2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in otherpopmenu2.
function otherpopmenu2_Callback(hObject, eventdata, handles)
% hObject    handle to otherpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns otherpopmenu2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from otherpopmenu2


% --- Executes during object creation, after setting all properties.
function otherpopmenu2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to otherpopmenu2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function EEGpopmenu3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EEGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function EOGpopmenu3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EOGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on selection change in EMGpopmenu3.
function EMGpopmenu3_Callback(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns EMGpopmenu3 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from EMGpopmenu3


% --- Executes during object creation, after setting all properties.
function EMGpopmenu3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to EMGpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function otherpopmenu3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to otherpopmenu3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
set(handles.currenttime1,'String',num2str(round(slidval+handles.winsize/2)));
set(handles.edit1,'String',num2str(handles.winsize));
set(handles.currentpage1,'String',num2str(ceil((slidval+handles.winsize/2)/handles.winsize)));
for i=1:maxi
    nosign=1;
    if handles.multcomp
...
%        set(handles.fftchan,'String',chanlabels(handles.Dmeg{1},handles.inddis))
        ...
        win =  floor((str2double(get(handles.currenttime1,'String')) - handles.winsize/2)/handles.winsize + 1);
   end
    ...
    if ~nosign  %if multiple comparison and no signal in the considered file
        ...
        for j=1:maxj
            ...
            if  any(index(j)==emgchannels(handles.Dmeg{i}))  %strfind(testcond{:},'EMG')
                contents = get(handles.EMGpopmenu1,'String');
                selchan=upper(contents{get(handles.EMGpopmenu1,'Value')});
            ...
            elseif any(index(j)==eogchannels(handles.Dmeg{i})) %strfind(testcond{:},'EOG')
                contents = get(handles.EOGpopmenu1,'String');
                selchan=upper(contents{get(handles.EOGpopmenu1,'Value')});
            ...
            elseif any(index(j)==ecgchannels(handles.Dmeg{i})) %strfind(testcond{:},'ECG'
                contents = get(handles.otherpopmenu1,'String');
                selchan=upper(contents{get(handles.otherpopmenu1,'Value')});
            ...
            elseif any(index(j)==meegchannels(handles.Dmeg{i})) %'EEG', 'MEGMAG', MEGPLANAR'               
                contents = get(handles.EEGpopmenu1,'String');
                selchan=upper(contents{get(handles.EEGpopmenu1,'Value')});
           ...
           %Plot data   
            ...
            if handles.scoring && ~isempty(handles.score{5,handles.currentscore}) && any(index(j)== handles.score{5,handles.currentscore}(:,3))
                ...
                l=1;
                tdebs   =   str2double(get(handles.currenttime1,'String'))-handles.winsize/2;
                tfins   =	str2double(get(handles.currenttime1,'String'))+handles.winsize/2;
            ...
            if ~isempty(handles.artefacteeg)
                ...
                %    X   =   get(plt,'YData');
                %    X   =   X(deb:fin);
                %    if length(X) < length(time_epo) % je ne comprends pas d'o?vient l'erreur, je mets donc un gardien suppl閙entaire pour corriger celle-ci lorsqu'elle apparait!
...
if handles.scoring && handles.winsize == handles.score{3,handles.currentscore} % New gardian to check the window size corresponds to those is used to score file
    ...
    currentwindow = floor(str2double(get(handles.currenttime1,'String'))/handles.winsize)+1;  
...
%if Mouse(1,2) > 0   %Even without score sleep, possibility to access from axes1 where we want on main screen
%    slidval = Mouse(1);
...
%        slidval=str2double(get(handles.currenttime1,'String'));
%    else
%        slidval = min(slidval, ...
...
if handles.Dmeg{1}.CRC.score{3,Val1}==handles.Dmeg{1}.CRC.score{3,Val2}
    ...
    set(handles.figure1,'CurrentAxes',handles.axes1);
    crc_hypnoplot(handles.axes1, handles, ...
...
% hObject    handle to score_check (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
score  = handles.score;
...
currentwindow   =	floor(str2double(get(handles.currenttime1,'String')) ...
                                /handles.winsize)+1;
