...
crc_def.par.Refnames = ...
    {'FP1' 'FP2' 'F3' 'F4' 'C3' 'C4' 'P3' 'P4' 'O1' 'O2' 'F7' 'F8' 'FZ' 'CZ' 'PZ' 'A1' 'A2' ...
    'T3' 'T4' 'T5' 'T6'};
...
crc_def.one.filtEEG    = [.3 35]; % in Hz
crc_def.one.filtEMG    = [10 100]; % max is adapted to true sampling rate
crc_def.one.filtEOG    = [.3 35]; % in Hz
crc_def.one.filtEkg    = [1 15]; % in Hz
crc_def.one.filtLeg    = [10 100]; % max is adapted to true sampling rate
crc_def.one.filtSnore    = [10 100];
crc_def.one.filtOther    = [.1 100];
...
crc_def.score.filtEEG    = [.3 35]; % in Hz
crc_def.score.filtEMG    = [10 100]; % max is adapted to true sampling rate
crc_def.score.filtEOG    = [.3 35]; % in Hz
crc_def.score.filtEkg    = [1 15]; % in Hz
crc_def.score.filtLeg    = [10 100]; % max is adapted to true sampling rate
crc_def.score.filtSnore    = [10 100]; % in Hz
crc_def.score.filtOther    = [.1 100]; % in Hz
