...
if (currentpage>1)&&any(((Arou.F7(currentpage-1,:))))&&(Arou.j_f7(1,currentpage-1)>0)&&...
        any((Arou.pos_F7(Arou.j_f7(1,currentpage-1),1,currentpage-1)))%如果上一页面末尾有纺锤波标记,且对应位置记录了坐标值%如果上一页面有纺锤波标记
    load('Arousalchan_data.mat');
...
if (currentpage<totalpage)&&any(((Arou.F7(currentpage+1,:))))&&(Arou.j_f7(1,currentpage+1)>0)...
        &&any((Arou.pos_F7(1,1,currentpage+1)))%如果下一页面有纺锤波标记
    load('Arousalchan_data.mat');
    if ((Arou.F7(currentpage+1,1)==1))%%如果上一页的开始标记有纺锤波，很可能这一页的结束也标记有
        down_x=min(Arou.pos_F7(1:Arou.j_f7(currentpage+1),1,currentpage+1));%下一页第一条线起始点的横坐标
        down_y=Arou.pos_F7(1,2,currentpage+1);%上一页第一条线起始点的纵坐标
...
if (currentpage>1)&&any(((Arou.F8(currentpage-1,:))))&&(Arou.j_f8(1,currentpage-1)>0)&&...
        any((Arou.pos_F8(Arou.j_f8(1,currentpage-1),1,currentpage-1)))%如果上一页面末尾有纺锤波标记,且对应位置记录了坐标值%如果上一页面有纺锤波标记
    load('Arousalchan_data.mat');
...
if (currentpage<totalpage)&&any(((Arou.F8(currentpage+1,:))))&&(Arou.j_f8(1,currentpage+1)>0)...
        &&any((Arou.pos_F8(1,1,currentpage+1)))%如果下一页面有纺锤波标记
    load('Arousalchan_data.mat');
    if ((Arou.F8(currentpage+1,1)==1))%%如果上一页的开始标记有纺锤波，很可能这一页的结束也标记有
        down_x=min(Arou.pos_F8(1:Arou.j_f8(currentpage+1),1,currentpage+1));%下一页第一条线起始点的横坐标
        down_y=Arou.pos_F8(1,2,currentpage+1);%上一页第一条线起始点的纵坐标
...
if (currentpage>1)&&any(((Arou.Fz(currentpage-1,:))))&&(Arou.j_Fz(1,currentpage-1)>0)&&...
        any((Arou.pos_Fz(Arou.j_Fz(1,currentpage-1),1,currentpage-1)))%如果上一页面末尾有纺锤波标记,且对应位置记录了坐标值%如果上一页面有纺锤波标记
    load('Arousalchan_data.mat');
...
if (currentpage<totalpage)&&any(((Arou.Fz(currentpage+1,:))))&&(Arou.j_Fz(1,currentpage+1)>0)...
        &&any((Arou.pos_Fz(1,1,currentpage+1)))%如果下一页面有纺锤波标记
    load('Arousalchan_data.mat');
    if ((Arou.Fz(currentpage+1,1)==1))%%如果上一页的开始标记有纺锤波，很可能这一页的结束也标记有
        down_x=min(Arou.pos_Fz(1:Arou.j_Fz(currentpage+1),1,currentpage+1));%下一页第一条线起始点的横坐标
        down_y=Arou.pos_Fz(1,2,currentpage+1);%上一页第一条线起始点的纵坐标
...
if (currentpage>1)&&any(((Arou.Cz(currentpage-1,:))))&&(Arou.j_Cz(1,currentpage-1)>0)&&...
        any((Arou.pos_Cz(Arou.j_Cz(1,currentpage-1),1,currentpage-1)))%如果上一页面末尾有纺锤波标记,且对应位置记录了坐标值%如果上一页面有纺锤波标记
    load('Arousalchan_data.mat');
...
if (currentpage<totalpage)&&any(((Arou.Cz(currentpage+1,:))))&&(Arou.j_Cz(1,currentpage+1)>0)...
        &&any((Arou.pos_Cz(1,1,currentpage+1)))%如果下一页面有纺锤波标记
    load('Arousalchan_data.mat');
    if ((Arou.Cz(currentpage+1,1)==1))%%如果上一页的开始标记有纺锤波，很可能这一页的结束也标记有
        down_x=min(Arou.pos_Cz(1:Arou.j_Cz(currentpage+1),1,currentpage+1));%下一页第一条线起始点的横坐标
        down_y=Arou.pos_Cz(1,2,currentpage+1);%上一页第一条线起始点的纵坐标
...
if (currentpage>1)&&any(((Arou.Pz(currentpage-1,:))))&&(Arou.j_Pz(1,currentpage-1)>0)&&...
        any((Arou.pos_Pz(Arou.j_Pz(1,currentpage-1),1,currentpage-1)))%如果上一页面末尾有纺锤波标记,且对应位置记录了坐标值%如果上一页面有纺锤波标记
    load('Arousalchan_data.mat');
...
if (currentpage<totalpage)&&any(((Arou.Pz(currentpage+1,:))))&&(Arou.j_Pz(1,currentpage+1)>0)...
        &&any((Arou.pos_Pz(1,1,currentpage+1)))%如果下一页面有纺锤波标记
    load('Arousalchan_data.mat');
    if ((Arou.Pz(currentpage+1,1)==1))%%如果上一页的开始标记有纺锤波，很可能这一页的结束也标记有
        down_x=min(Arou.pos_Pz(1:Arou.j_Pz(currentpage+1),1,currentpage+1));%下一页第一条线起始点的横坐标
        down_y=Arou.pos_Pz(1,2,currentpage+1);%上一页第一条线起始点的纵坐标
